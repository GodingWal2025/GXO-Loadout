export const pallet: Record<string, string> = {
  ...
  'pallet.expectedCount': 'Cantidad esperada',
  'pallet.actualCount': 'Cantidad real',
  'pallet.fromPicklistLine': 'De la línea de la lista de surtido para {batch}',
  'pallet.enterBatchFirst': 'Ingrese primero el código de lote',
  ...
  'pallet.seedpakCountOne': '{count} SeedPak',
  'pallet.seedpaksCount': '{count} SeedPaks',
  'pallet.minibulkCountOne': '{count} Minibulk',
  'pallet.minibulksCount': '{count} Minibulks',
  'pallet.palletsCountOne': '{count} tarima',
  'pallet.palletsCount': '{count} tarimas',
  'pallet.containersCountOne': '{count} contenedor',
  'pallet.containersCount': '{count} contenedores',
