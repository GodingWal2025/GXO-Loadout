export const verify: Record<string, string> = {
  ...
  'verify.unit': 'Unidad',
  'verify.spSize': 'SeedPak · {ssu}',
  'verify.mbSize': 'Minibulk · {ssu}',
  'verify.lineDelivery': 'Entrega',
  'verify.lineDeliveryNone': 'Sin asignar',
  'verify.lineDeliveryFallback': 'Entrega {n}',
  ...
  // ---- VerifyInboundRoute ----
  'verifyInbound.titleLead': 'Entrada',
  'verifyInbound.titleEm': 'Registro de verificación',
  'verifyInbound.subtitle': 'Paso 3 de 3 · Verifique artículos recibidos, cantidades, daños y ubicaciones',
  'verifyInbound.headerDetailsLead': 'Encabezado',
  'verifyInbound.headerDetailsEm': 'del registro',
  'verifyInbound.bolNumber': '# de BoL / # de carga',
  'verifyInbound.deliveryNumber': '# de entrega',
  'verifyInbound.stagingLanes': 'Carril(es) de preparación',
  'verifyInbound.verifier': 'Verificador',
  'verifyInbound.dateReceived': 'Fecha de recepción',
  'verifyInbound.dateVerified': 'Fecha de verificación',
  'verifyInbound.lineItemsLead': 'Productos',
  'verifyInbound.lineItemsEm': 'recibidos',
  'verifyInbound.addItem': 'Agregar artículo',
  'verifyInbound.noItems': 'Aún no se han agregado filas de productos',
  'verifyInbound.noItemsHint': 'Toque "+ Agregar artículo" para registrar los lotes recibidos.',
  'verifyInbound.inInventory': 'En inventario',
  'verifyInbound.manualBatch': 'No está en inventario',
  'verifyInbound.damagedBadge': '{count} dañados',
  'verifyInbound.removeLine': 'Quitar fila',
  'verifyInbound.colBatch': 'Lote',
  'verifyInbound.colMaterial': 'Material / SKU',
  'verifyInbound.colUom': 'Empaque / UOM',
  'verifyInbound.colDesc': 'Descripción',
  'verifyInbound.colLoc': 'LOC (Ubicación)',
  'verifyInbound.colQtyReceived': 'Cant. recibida',
  'verifyInbound.colQtyDamaged': 'Cant. dañada',
  'verifyInbound.colOnBol': '¿En BOL?',
  'verifyInbound.yes': 'Sí',
  'verifyInbound.no': 'No',
  'verifyInbound.damagePhotosTitle': 'Fotos de daños ({count})',
  'verifyInbound.takeDamagePhoto': 'Tomar foto de daño',
  'verifyInbound.damagePhotoHint': 'Fotografíe las unidades o empaques dañados.',
  'verifyInbound.damageThumb': 'Daño',
  'verifyInbound.damagePhotos': 'Fotos de daños',
  'verifyInbound.summaryLines': 'Artículos registrados',
  'verifyInbound.summaryReceived': 'Total recibido',
  ...
  'review.load': 'Carga',
  'review.subInbound': '{count} artículos registrados · Registro de verificación de entrada',
  ...
  'review.attestInbound':
    'He verificado personalmente esta carga de entrada contra el BOL y el papeleo. Todos los conteos de producto recibido, lotes y daños están registrados con precisión.',
