export const admin: Record<string, string> = {
  ...
  'dashboard.clickToFilter': 'Haga clic para filtrar el panel por este sitio',
  ...
  'dashboard.byInspectorEm': 'empleado',
  'dashboard.byInspectorMeta': 'Ordenado por volumen',
  'dashboard.noInspectors': 'Ningún empleado activo en el período seleccionado.',
  ...
  'dashboard.colInsp': 'Emp.',
  'dashboard.colStatus': 'Estado',
  'dashboard.colInspector': 'Empleado',
  'dashboard.colFlawless': 'Impecable',
  'dashboard.colDiscCaught': 'Discr. detectadas',
  'dashboard.colAccuracy': 'Precisión',
  'dashboard.colLph': 'Cargas/Hr',
