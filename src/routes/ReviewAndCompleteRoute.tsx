...
import { actualCountInUom, actualCountUom, isPackagingLine, picklistHasOcr } from '../shared';
                  ...
                  return (
                    <tr key={li.id} style={isExcludedPackaging ? { opacity: 0.45 } : undefined}>
                      ...
                      <td className="right num fw-500">
                        {actualCountInUom(li.uom, li.actualQuantity, li.description.value)}{' '}
                        {actualCountUom(li.uom)}
                      </td>
                      <td className="right">
                        {isExcludedPackaging ? (
